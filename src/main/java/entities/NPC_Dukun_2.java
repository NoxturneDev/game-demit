...
public class NPC_Dukun_2 extends Entity{
    ...
    public void setDialogue() {
        dialogues[0][0] = "Kau harus selalu berhati hati diluar sini";
        dialogues[0][1] = "Pakailah batik yang nanti akan kau temukan";
        dialogues[0][2] = "Pakaian traditional ini akan memberikan kekuatan";

        dialogues[1][0] = "Kain ini bersejarah.";
        dialogues[1][1] = "Memiliki corak khas berbentuk pola";
    }
